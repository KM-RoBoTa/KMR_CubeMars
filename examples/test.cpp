 ...
 ********************************************************************************************
 * @file    test.cpp
 * @brief   Example for position control with debug
...
vector<int> ids = {42, 41, 43}; 
int nbrMotors = ids.size();
vector<KMR::CBM::Model> models{KMR::CBM::Model::AK80_8, KMR::CBM::Model::AK80_8, KMR::CBM::Model::AK80_8};
...
int main()
{
    ...
    //cout << "Sleeping before return" << endl;
    //sleep(1);
